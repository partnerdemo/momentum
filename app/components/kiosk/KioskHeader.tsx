...
export default function KioskHeader() {
    ...
    return (
        <header className="relative h-64 rounded-[32px] overflow-hidden mb-12 shadow-[0_30px_60px_-15px_rgba(30,27,75,0.4)] border border-white/10 group">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-950 via-slate-900 to-blue-950 transition-all duration-700 ease-in-out group-hover:scale-105" />

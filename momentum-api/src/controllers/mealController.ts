...
export const createRecipe = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    const { name, description, ingredients, instructions, prepTimeMinutes, cookTimeMinutes, image, tags } = req.body;
    const recipe = await Recipe.create({ name, description, ingredients, instructions, prepTimeMinutes, cookTimeMinutes, image, tags, householdId });
...
export const updateRecipe = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    const recipe = await Recipe.findOneAndUpdate(
        ...
        { name, description, ingredients, instructions, prepTimeMinutes, cookTimeMinutes, image, tags },
...
export const createRestaurant = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    const { name, cuisine, address, location, phone, website, priceRange, favoriteOrders } = req.body;
    const restaurant = await Restaurant.create({ name, cuisine, address, location, phone, website, priceRange, favoriteOrders, householdId });
...
export const updateRestaurant = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    const restaurant = await Restaurant.findOneAndUpdate(
        { _id: id, householdId: req.householdId },
        { name, cuisine, address, location, phone, website, priceRange, favoriteOrders },
        { new: true, runValidators: true }
    );
...
export const addMealToPlan = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    const { date, mealType, itemType, itemId, customTitle } = req.body;
